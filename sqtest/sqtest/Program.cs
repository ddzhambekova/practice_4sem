...
<p><input type=""submit"" value=""send""></p>
        ...
        static void CheckDBToSend()
        {
            while (true)
            {
                ...
                SQLiteConnection newconnection = new SQLiteConnection("Data Source=C:\\testik.db; Version=3");
                newconnection.Open();
                DateTime timeadd;
        ...
        static void CheckDBToDelete()
        {
            while (true)
            {
                ...
                foreach (DbDataRecord record in reader7)
                {
                    ...
                    {
                        SQLiteCommand deletemessage = connection.CreateCommand();
